...
def simulate_and_plot_trajectories(baseline_controller, dro_controller, simulate_mountaincar, plot_trajectories, plot_actions):
    ...
    for controller_type, controller in [('Baseline', baseline_controller), ('DR', dro_controller)]:
        ...
        plot_trajectories(trajectories, positions, velocities, f'{controller_type} Controller: Mountain Car Trajectories', 'Position', 'Velocity')
...
def main():
    ...
    dro_clf_saved_model = "saved_models/joint_clf_controller_models/mountain_car/dro_clf.pt"
    dro_policy_model = "saved_models/joint_clf_controller_models/mountain_car/dro_controller.pt"
