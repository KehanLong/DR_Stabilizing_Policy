...
class CartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    ...
    **Note:** While the ranges above denote the possible values for observation space of each element,
    ...
    def __init__(self, render_mode: Optional[str] = None, mc = 1.0, mp = 1.0, l = 1.0):
        self.gravity = 9.81
        self.masscart = mc
        self.masspole = mp
    ...
    def render(self):
        ...
        if self.render_mode == "human":        
            ...
            # Render text
            info_text = f"Mass of Cart: {self.masscart}, Mass of Pole: {self.masspole}, Length: {self.length}"
